package com.cowboy76.guesthouse.batch.listener;
...
public class CustomJobExecutionListener implements JobExecutionListener {
	...
	private static final Log LOGGER = LogFactory.getLog(CustomJobExecutionListener.class);
	...
	public void afterJob(JobExecution jobExecution) {
		...
		protocol.append("  ExitCode   : " + jobExecution.getExitStatus().getExitCode() + "\n");

		protocol.append("  ExitDescr. : " + jobExecution.getExitStatus().getExitDescription() + "\n");

		protocol.append("  Status      : " + jobExecution.getStatus() + "\n");

		protocol.append("+++++++++++++++++++++++++++++++++++++++++++++++++++++++ \n");

		protocol.append("JobParameter: \n");
